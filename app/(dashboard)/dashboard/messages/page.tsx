import Explanations, { TExplanation } from "@/components/dashboard/ui/explanations";
...
export default async function AdminHoursPage() {
  ...
  return (
    <div className="container min-h-screen px-4 mt-10">
      {/* <pre>{JSON.stringify(users, null, 2)}</pre> */}

      <TextMain text="Gestion des messages" />

      <p className="text-sm italic font-light">Messages obtenus via la boite de contact</p>
      {/* explanations status */}
