...
export const metadata = {
  title: "Mentions légales | Garage V. Parrot",
  description:
    "Bienvenue sur le site Garage V. Parrot. Nous sommes spécialisés dans la réparation, l'entretien et la vente de véhicules de toutes marques. Consultez les mentions légales du site Garage Parrot !",
};
    ...
    <div>
      ...
      <div className="container mx-auto px-4 mb-[100px] lg:px-[200px]">
        <div className="flex flex-col space-y-2 font-medium text-base mb-[50px]">
          <p>
            La société GARAGE V.PARROT, soucieuse des droits des individus, notamment au regard des traitements
          ...
          <p>
            ...
            <a target="_blank" rel="noreferrer" href="https://www.cnil.fr/" className="text-blue-600 hover:underline">
